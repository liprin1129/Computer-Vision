...
int OpticalFlowManager::startOpticalFlow(std::vector<cv::cuda::GpuMat> &cvSideBySideGpuMatFrames) {
    //const int64 start = cv::getTickCount();

    // Calculate optical flow
    farn->calc(cvSideBySideGpuMatFrames[0], cvSideBySideGpuMatFrames[1], _flowSideBySideGpuMat);
